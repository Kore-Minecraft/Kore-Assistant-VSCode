...
import { COPY_LINK_COMMANDS, DEFAULT_VIEW_OPTIONS, elementTooltip, KoreGroupBy, KoreSortBy, KoreTreeDataProvider, KoreTreeItem, KoreViewOptions, RULE } from './koreTreeView';
...
export function gutterHover(element: ResolvedKoreElement): vscode.MarkdownString {
	...
	hover.isTrusted = { enabledCommands: [...COPY_LINK_COMMANDS, 'kore-assistant.revealInExplorer'] };
	return hover;
}
