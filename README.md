...
[![Version](https://img.shields.io/badge/version-0.4.0-blue.svg)](https://marketplace.visualstudio.com/items?itemName=ayfri.kore-assistant)
...
6. Right-click a gutter icon (or anywhere in a Kotlin editor) and pick "Kore: Reveal in Kore Explorer", or click the link at the end of the gutter hover, to select that declaration in the tree
